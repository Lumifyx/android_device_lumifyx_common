...
PRODUCT_COPY_FILES += \
    ...
    device/lumifyx/common/tv/init.enableswap.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.enableswap.rc \
    device/lumifyx/common/tv/fstab.enableswap:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.enableswap
